...
STORED AS TEXTFILE
LOCATION '/user/w205/hospital_compare_new/hospitals'
;
...
STORED AS TEXTFILE
LOCATION '/user/w205/hospital_compare_new/effective_care'
;
...
STORED AS TEXTFILE
LOCATION '/user/w205/hospital_compare_new/readmissions'
;
...
STORED AS TEXTFILE
LOCATION '/user/w205/hospital_compare_new/Measures'
;
...
(
   ...
   communication_with_doctors_improvement_point string,
...
STORED AS TEXTFILE
LOCATION '/user/w205/hospital_compare_new/surveys_responses'
;
